/*
 * @class       MovieRepository class
 * @version     1.0.0
 * @date        19.04.16
 * @author      OHSANG SEO (tjdhtkd@gmail.com)
 * @brief       store movie data.
 */
...
public class MovieRepository {
    ...
    static {
        ...
        movie4.addPlaySchedule(new PlaySchedule(createDateTime("2019-12-30 23:59"), 2)); // add schedule for Debug
    ...
    public static boolean hasMovieId(int movieId) {
        ...
        for (Movie movie : movies) {
            hasId = hasId || movie.isMovieId(movieId);
        }
        return hasId;
    }

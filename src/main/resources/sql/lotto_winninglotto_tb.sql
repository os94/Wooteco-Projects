...
--
-- Table structure for table `winninglotto_tb`
--
...
--
-- Dumping data for table `winninglotto_tb`
--

LOCK TABLES `winninglotto_tb` WRITE;
/*!40000 ALTER TABLE `winninglotto_tb` DISABLE KEYS */;
/*!40000 ALTER TABLE `winninglotto_tb` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-06-14 23:00:12

...
public class AnnotationHandlerMapping implements HandlerMapping {
    ...
    private final ClasspathBeanFactory classpathBeanFactory;

    private Map<HandlerKey, HandlerExecution> handlerExecutions = Maps.newHashMap();

    public AnnotationHandlerMapping(ClasspathBeanFactory classpathBeanFactory) {
        this.classpathBeanFactory = classpathBeanFactory;
    }
